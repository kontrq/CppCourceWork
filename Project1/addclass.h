...
namespace Project1 {
	...
	private: String^ connectionInfo = "datasource=localhost;port=3306;username=root;password=;database=kursach";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(138, 174);
			...
			this->label1->Text = L"Выберите номер и букву класса";
			// 
			// comboBox12
			// 
			this->comboBox12->FormattingEnabled = true;
			this->comboBox12->Location = System::Drawing::Point(139, 147);
			...
			this->comboBox11->Location = System::Drawing::Point(139, 120);
			...
			this->comboBox10->Location = System::Drawing::Point(139, 93);
			...
			this->comboBox9->Location = System::Drawing::Point(12, 228);
			...
			this->comboBox8->Location = System::Drawing::Point(139, 66);
			...
			this->comboBox7->Location = System::Drawing::Point(12, 201);
			...
			this->comboBox6->Location = System::Drawing::Point(12, 174);
			...
			this->comboBox5->Location = System::Drawing::Point(12, 147);
			...
			this->comboBox4->Location = System::Drawing::Point(12, 120);
			...
			this->comboBox3->Location = System::Drawing::Point(12, 93);
			...
			this->comboBox2->Location = System::Drawing::Point(12, 66);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(138, 226);
			...
			this->comboBox13->Items->AddRange(gcnew cli::array< System::Object^  >(7) { L"a", L"b", L"c", L"d", L"e", L"f", L"g" });
			this->comboBox13->Location = System::Drawing::Point(139, 25);
			this->comboBox13->Name = L"comboBox13";
			this->comboBox13->Size = System::Drawing::Size(120, 21);
			...
			this->ClientSize = System::Drawing::Size(275, 259);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		{
			MySqlDataReader^ dataReader = MySqlWork::ExecuteQuery("SELECT * FROM classes WHERE class='" + comboBox1->Text + "" + comboBox13->Text + "'");
			if (dataReader == nullptr) {
				MySqlWork::ExecuteQuery("INSERT INTO classes(class) VALUES('" + comboBox1->Text + "" + comboBox13->Text + "')");
				if (comboBox2->Text != "")
				{
