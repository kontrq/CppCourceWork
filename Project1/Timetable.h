...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listBox3->Size = System::Drawing::Size(188, 121);
			...
			this->comboBox2->Location = System::Drawing::Point(180, 39);
			...
			this->label5->Location = System::Drawing::Point(136, 42);
			...
			this->button1->Size = System::Drawing::Size(88, 47);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(213, 210);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(113, 210);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(89, 47);
			...
			this->button4->Size = System::Drawing::Size(88, 47);
			...
			this->comboBox3->Size = System::Drawing::Size(289, 21);
			...
			this->comboBox4->Size = System::Drawing::Size(289, 21);
			...
			this->label7->Text = L"Выберите номер урока";
			// 
			// button5
			// 
			this->button5->Location = System::Drawing::Point(113, 210);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(213, 210);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(88, 47);
			...
			this->ClientSize = System::Drawing::Size(318, 269);
...
private: System::Void Timetable_Load(System::Object^  sender, System::EventArgs^  e) {
	...
	MySqlDataReader^ dataReader = ExecuteQuery("SELECT class from classes");
...
private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
	if (comboBox1->Text != "" && comboBox2->Text != "" && comboBox3->Text != "")
	{
		...
		{
			MessageBox::Show("В это время у этого класса нет урока");
		}
	}
	else
	{
