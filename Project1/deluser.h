...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(145, 53);
			...
			this->label1->Text = L"Введите логин ученика для удаления";
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
	if (textBox1->Text != "")
	{
		...
		if (dataReader != nullptr) {
			...
			MySqlWork::ExecuteQuery("DELETE FROM ucheniki WHERE login ='" + textBox1->Text + "'");
