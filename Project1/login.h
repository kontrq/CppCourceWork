...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Size = System::Drawing::Size(100, 59);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(118, 145);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(109, 59);
			...
			this->label5->Text = L"Школьный журнал";
			// 
			// checkBox1
			// 
			this->checkBox1->AutoSize = true;
			this->checkBox1->Location = System::Drawing::Point(12, 124);
