...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(145, 119);
			...
			this->listBox2->Location = System::Drawing::Point(145, 119);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	{
		MySqlDataReader^ dataReader2 = ExecuteQuery("SELECT login, name from ucheniki WHERE class = '" + comboBox1->Text + "'");
		...
		{
			MessageBox::Show("Такой предмет уже есть у этого класса");
		}
	}
	else
	{
