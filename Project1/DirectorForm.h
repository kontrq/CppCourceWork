...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Text = L"Добавить класс";
			...
			this->button3->Text = L"Добавить ученика";
			...
			this->button4->Text = L"Добавить учителя";
			...
			this->button5->Text = L"Удалить ученика";
			...
			this->button6->Text = L"Изменить учителя";
			this->button6->UseVisualStyleBackColor = true;
			this->button6->Click += gcnew System::EventHandler(this, &DirectorForm::button6_Click);
			// 
			// button7
			// 
			this->button7->Location = System::Drawing::Point(23, 254);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(150, 45);
			...
			// button8
			// 
			this->button8->Location = System::Drawing::Point(179, 254);
			this->button8->Name = L"button8";
			this->button8->Size = System::Drawing::Size(150, 45);
			...
			// button9
			// 
			this->button9->Location = System::Drawing::Point(23, 202);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(149, 46);
			...
			// button10
			// 
			this->button10->Location = System::Drawing::Point(179, 203);
			this->button10->Name = L"button10";
			this->button10->Size = System::Drawing::Size(151, 45);
			this->button10->TabIndex = 9;
			this->button10->Text = L"Добавить предмет в сущ. класс";
			...
			this->ClientSize = System::Drawing::Size(360, 311);
